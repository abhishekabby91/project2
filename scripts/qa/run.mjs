 ...
 * responsive layout on real phone and iPad viewports, keyboard and interaction
 * behaviour, form validation end to end,
...
console.log("\n## Responsive layout — phones and iPads\n");
const responsive = await run("responsive.mjs");
console.log("\n## Cookie consent\n");
const consent = await run("consent.mjs");

const failed = a11y !== 0 || interaction !== 0 || responsive !== 0 || consent !== 0;
